          ...
          <Col md="10">
            <Suspense fallback={<Loading />}>
              <Routes>
                ...
                <Route
                  path="/view-employees"
                  element={<ListAllEmployeesComponent />}
                />
                <Route
                  path="/add-employee"
                ...
                <Route
                  path="/update-item/:id"
                  element={<AddItemComponenet />}
                />

                <Route
                  path="/view-shopOwners"
                  element={<ListAllShopOwnersComponent />}
                />
                <Route
                  path="/add-shopOwner"
                  element={<AddShopOwnerComponent />}
                />
                <Route
                  path="/update-shopOwner/:id"
                  element={<AddShopOwnerComponent />}
                />
              </Routes>
            </Suspense>
